        ...
        <Container variant="readable">
          <Flex flexDirection="column" gap={5}>
            ...
            <Text textStyle="standard">
              ...
              kombinasjonen av å få skape noe, som også har positiv påvirkning
              for de menneskene vi jobber med er det som motiverer oss.
            </Text>
            <Box
              sx={{
                pb: 8,
            ...
            >
              <Link as={NextLink} href={'/principles'} variant="socials">
          ...
          <Flex flexDirection="column" pt={{ base: 5, md: 8 }} gap={3}>
            <Text textStyle="standard">Besøk oss i Myntgata 2, 0152 Oslo</Text>
            <Flex flexDirection="column">
              <Text textStyle="standard" fontWeight="semibold">
                kontoret@bjerk.io
              </Text>
              <Text textStyle="standard" fontWeight="semibold">
                +47 22 12 05 12
