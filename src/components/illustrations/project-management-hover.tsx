...
export interface ProjectManagementHoverProps extends BoxProps {
  width?: number;
  height?: number;
}

export const ProjectManagementHover: React.FC<ProjectManagementHoverProps> = ({
  width = 107.71,
  height = 57.99,
  ...props
}) => (
...
ProjectManagementHover.displayName = 'ProjectManagementHover';

export default ProjectManagementHover;
